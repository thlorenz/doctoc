...
test('\ngiven a file that includes html with header tags and maxHeaderLevel 8', function (t) {
  ...
  t.same(
    ...
    , [ '**Table of Contents**  *generated with [DocToc](https://github.com/thlorenz/doctoc)*',
        ...
        '- [API](#api)',
        '    - [dockops::Containers(docker) → {Object}](#dockops::Containers)',
        '      - [Parameters:](#parameters)',
        '      - [Returns:](#returns)',
        '    - [dockops::Containers::activePorts(cb)](#dockops::Containers::activePorts)',
        '      - [Parameters:](#parameters-1)',
        '    - [dockops::Containers::clean(id, cb)](#dockops::Containers::clean)',
