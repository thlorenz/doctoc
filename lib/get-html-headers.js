...
function rankify(headers, max, noh1) {
  return headers
    .map(function (x) {
    ...
    .filter(function (x) {
      return x.rank <= max && (!noh1 || x.rank > 1);
    })
}

var go = module.exports = function (lines, maxHeaderLevel, noh1) {
  ...
  headers = rankify(headers, maxHeaderLevel, noh1);
  return headers;
}
