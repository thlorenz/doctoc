...
function getMarkdownHeaders (lines, start, maxHeaderLevel, minHeaderLevel, syntax) {
  ...
  function isHtmlHeader (html, minHeaderLevel, maxHeaderLevel) {
  ...
  return lines
    ...
    .map(function (x) {
      if ((x.type === md.Syntax.Html || x.type === md.Syntax.HtmlBlock) && isHtmlHeader(x.raw, minHeaderLevel, maxHeaderLevel)) {
