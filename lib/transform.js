...
exports = module.exports = function transform(content, mode, maxHeaderLevel, title, notitle, editMessage, entryPrefix, processAll, updateOnly) {
  ...
  var wrappedToc =  start + editMessage + '\n' + toc + '\n' + end;
