...
exports = module.exports = function transform(content, mode, maxHeaderLevel, minHeaderLevel, minTocItems, title, notitle, entryPrefix, processAll, updateOnly, syntax, padTitle) {
  syntax = syntax || "md"
  ...
  var allHeaders    =  countHeaders(headers),
    lowestRank    =  Math.min.apply(null, allHeaders.map(h => h.rank)),
